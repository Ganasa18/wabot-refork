...
const handler = async (m, { text, args, conn, command }) => {
  ...
  if (command === "animeinfo") {
    if (!text || !text.startsWith("http"))
      throw `Contoh: .${command} https://nontonanime.live/naruto/`;
...
handler.help = [
  ...
  "searchanime <judul>",
  "animeinfo <url>",
  "downloadanime <url_episode>",
];
handler.tags = ["anime"];
handler.limit = true;
handler.command =
  /^latestanime|upcominganime|searchanime|animeinfo|downloadanime$/i;
