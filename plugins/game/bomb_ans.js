  ...
  try {
    ...
    if (
      ...
      if (!json)
        return this.reply(
          m.chat,
          `🚩 Untuk membuka kotak kirim angka 1 - 9`,
          m
        );
      ...
      if (json.emot == "💥") {
        ...
        teks += `*Permainan selesai!*, kotak berisi bom terbuka : (- *${formatNumber(
          reward
        )}*)`;
        ...
        if (open >= 8) {
          ...
          teks +=
            changes
              ...
              .join("") + "\n\n";
          teks += `Timeout : [ *${timeout / 1000 / 60} menit* ]\n`;
          teks += `*Permainan selesai!* kotak berisi bom tidak terbuka : (+ *${formatNumber(
            reward
          )}*)`;
          ...
          teks +=
            changes
              ...
              .join("") + "\n\n";
          teks += `Timeout : [ *${timeout / 1000 / 60} menit* ]\n`;
          teks += `Kotak berisi bom tidak terbuka : (+ *${formatNumber(
            reward
          )}*)`;
